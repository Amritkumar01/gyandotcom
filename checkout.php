...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_SESSION['user_data'] = [
        ...
        'mentorSelect' => $_POST['mentorSelect']  // Assuming the form field for helper selection is named 'mentorSelect'
    ];
}
...
$checkout_session = \Stripe\Checkout\Session::create([
    "mode" => "payment",
    "success_url" => "http://localhost/Gyan.com1/submit1_form.php",
